...
class monitor():
    ...
    def send_email(self):
        ...
        self.conver_pdf_day_s1    = (datetime.datetime.now()+datetime.timedelta(days=-1)).strftime("%Y-%m-%d") + '_S-1(WHFP-1-25).pdf'
        self.conver_pdf_day_s2    = (datetime.datetime.now()+datetime.timedelta(days=-1)).strftime("%Y-%m-%d") + '_S-2(WHFP-1-30).pdf'
        self.conver_pdf_day_s3    = (datetime.datetime.now()+datetime.timedelta(days=-1)).strftime("%Y-%m-%d") + '_S-3(WHR-1).pdf'
        self.conver_pdf_day_s4    = (datetime.datetime.now()+datetime.timedelta(days=-1)).strftime("%Y-%m-%d") + '_S-4(WHFP-3-30-C).pdf'
        self.conver_pdf_day_s5    = (datetime.datetime.now()+datetime.timedelta(days=-1)).strftime("%Y-%m-%d") + '_S-5(WHFP-3-30-B).pdf'
        self.conver_pdf_day_s6    = (datetime.datetime.now()+datetime.timedelta(days=-1)).strftime("%Y-%m-%d") + '_S-6(WHFP-3-25).pdf'
        self.conver_pdf_day_s7    = (datetime.datetime.now()+datetime.timedelta(days=-1)).strftime("%Y-%m-%d") + '_S-7(WHFP-3-30-A).pdf'
        self.conver_pdf_day_s8    = (datetime.datetime.now()+datetime.timedelta(days=-1)).strftime("%Y-%m-%d") + '_S-8(WHFP-2).pdf'
        self.conver_pdf_day_s9    = (datetime.datetime.now()+datetime.timedelta(days=-1)).strftime("%Y-%m-%d") + '_S-9(WHR-2).pdf'
        self.conver_pdf_day_s10   = (datetime.datetime.now()+datetime.timedelta(days=-1)).strftime("%Y-%m-%d") + '_S-10(WHM).pdf'
        self.conver_pdf_day_s11_1 = (datetime.datetime.now()+datetime.timedelta(days=-1)).strftime("%Y-%m-%d") + '_S-11-1(SR-1).pdf'
        self.conver_pdf_day_s11_2 = (datetime.datetime.now()+datetime.timedelta(days=-1)).strftime("%Y-%m-%d") + '_S-11-2(SR-1-CS).pdf'
        self.conver_pdf_day_s12   = (datetime.datetime.now()+datetime.timedelta(days=-1)).strftime("%Y-%m-%d") + '_S-12(SR-2).pdf'
        self.conver_pdf_day_s13   = (datetime.datetime.now()+datetime.timedelta(days=-1)).strftime("%Y-%m-%d") + '_S-13(SR-2-CS).pdf'
        self.conver_pdf_day_s14   = (datetime.datetime.now()+datetime.timedelta(days=-1)).strftime("%Y-%m-%d") + '_S-14(WHRE).pdf'
        self.conver_pdf_day_s15_1 = (datetime.datetime.now()+datetime.timedelta(days=-1)).strftime("%Y-%m-%d") + '_S-15-1(SB-1).pdf'
        self.conver_pdf_day_s15_2 = (datetime.datetime.now()+datetime.timedelta(days=-1)).strftime("%Y-%m-%d") + '_S-15-2(SB-2).pdf'
        self.conver_pdf_day_s15_3 = (datetime.datetime.now()+datetime.timedelta(days=-1)).strftime("%Y-%m-%d") + '_S-15-3(SB-3).pdf'
        self.conver_pdf_day_s15_4 = (datetime.datetime.now()+datetime.timedelta(days=-1)).strftime("%Y-%m-%d") + '_S-15-4(SB-4).pdf'
        self.conver_pdf_day_s15_5 = (datetime.datetime.now()+datetime.timedelta(days=-1)).strftime("%Y-%m-%d") + '_S-15-5(SB-5).pdf'
        self.conver_pdf_day_s15_6 = (datetime.datetime.now()+datetime.timedelta(days=-1)).strftime("%Y-%m-%d") + '_S-15-6(SB-6).pdf'
        self.conver_pdf_day_s16   = (datetime.datetime.now()+datetime.timedelta(days=-1)).strftime("%Y-%m-%d") + '_S-16(WIP).pdf'
        self.conver_pdf_day_s17   = (datetime.datetime.now()+datetime.timedelta(days=-1)).strftime("%Y-%m-%d") + '_S-17(WHFP-2-CS).pdf'
        self.conver_pdf_day_s18   = (datetime.datetime.now()+datetime.timedelta(days=-1)).strftime("%Y-%m-%d") + '_S-18(WHFP-3-CS).pdf'
